    ...
    <section class="content">
      ...
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title text-primary"><i class="fa fa-truck"> </i> Data Mobil</h3>
						...
						$result = $mysqli->query("select * from mobil");
							if($result->num_rows != 0){
								while ($row = $result->fetch_assoc()) {
									...
									echo '<td>
											<div class="btn-group">
											  <a href="detail-mobil.php?id='.$row['id_mobil'].'" class="fa fa-search btn btn-primary btn-sm"></a>';
									if($_SESSION['level']=='satpam'){
										echo  '<a href="edit-mobil.php?id='.$row['id_mobil'].'" class="fa fa-edit btn btn-info btn-sm"></a>
											   <a href="print-mobil.php?id='.$row['id_mobil'].'" class="fa fa-file btn btn-success btn-sm" target="_blank"></a>';
									}
									echo  '</div>
										  </td>';
									echo "</tr>";

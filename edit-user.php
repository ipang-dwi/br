    ...
    <section class="content">
      ...
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title text-primary"><i class="fa fa-edit"> </i> Edit User</h3>
            ...
            <form class="form-horizontal" enctype="multipart/form-data" method="post" action="proses-edit-user.php?id=<?php echo $_GET['id'];?>">
			  ...
			  <div class="box-body">
				...
				<div class="form-group">
                  ...
                  <div class="col-sm-10">
					<select class="form-control" name="level" id="level">
						<option value="satpam" <?php if($row['level']=='satpam') echo "selected";?>>Satpam</option>
						<option value="admin gudang" <?php if($row['level']=='admin gudang') echo "selected";?>>Admin Gudang</option>
				...
				<div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control pull-right" id="datepicker" name="since" value="<?php echo date('d/m/Y',strtotime($row['since']));?>" required />
                  </div>
                </div>
				<div class="form-group">

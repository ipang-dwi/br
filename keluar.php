    ...
    <section class="content">
      ...
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title text-primary"><i class="fa fa-check-square"> </i> Data Keluar</h3>
        ...
        <div class="box-body">
          <div class="row">
			<div class="col-lg-12 col-xs-12">
				...
				<tbody>
					<?php 
						$result = $mysqli->query("select * from mobil where status != 'belum muat'");
							if($result->num_rows != 0){
								while ($row = $result->fetch_assoc()) {
									...
									$muat = new DateTime($row['muat']);
									$keluar = new DateTime($row['keluar']);
									echo "<td>".$masuk->format('d-m-Y H:i:s')."</td>";
									echo "<td>".$muat->format('d-m-Y H:i:s')."</td>";
									echo "<td>".$keluar->format('d-m-Y H:i:s')."</td>";*/
									...
									echo '<td>';
									if($row['status']=='proses muat')
										echo '<a href="proses-keluar.php?id='.$row['id_mobil'].'" class="fa fa-sign-out btn btn-primary btn-sm"> Finish</a>';
									echo  '</div>
										  </td>';
									echo "</tr>";
								}

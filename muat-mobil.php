  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Proses Muat Mobil</li>
      </ol>
    </section>
    ...
    <section class="content">
      ...
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title text-primary"><i class="fa fa-plus-square"> </i> Proses Muat Mobil</h3>
        ...
        <!-- form start -->
            <form class="form-horizontal" method="post" action="proses-muat.php?id=<?php echo $_GET['id'];?>">
              <div class="row">
			  ...
			  <div class="box-body">
                ...
                <div class="form-group">
                  <label for="id" class="col-sm-2 control-label">No Daftar</label>

                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="id" id="id" value="<?php echo $row['id_mobil'];?>" placeholder="No. Daftar" disabled />
                  </div>
                </div>
				<div class="form-group">
                  <label for="No. SPE" class="col-sm-2 control-label">No. SPE</label>

                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="spe" id="spe" value="<?php echo $row['spe'];?>" placeholder="No. SPE" />
                  </div>
                </div>
				<div class="form-group">

    ...
    <section class="content">
      ...
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title text-primary"><i class="fa fa-bus"> </i> Daftar Mobil</h3>
            ...
            <form class="form-horizontal" method="post" action="daftar.php">
			  ...
			  <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="ekspedisi" id="ekspedisi" placeholder="Nama Ekspedisi" required />
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="jenis" id="jenis" placeholder="Jenis Mobil" required />
                  </div>
                </div>
				<div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="nopol" id="nopol" placeholder="No. Polisi" required />
                  </div>
                </div>
				<div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="supir" id="supir" placeholder="Nama Supir" required />
                  </div>
                </div>
				<div class="form-group">

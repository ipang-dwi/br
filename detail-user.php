    ...
    <section class="content">
      ...
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title text-primary"><i class="fa fa-user"> </i> Detail User</h3>
            ...
            <form class="form-horizontal" enctype="multipart/form-data" method="post" action="proses-user.php">
			  ...
			  <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="user" id="user" value="<?php echo $row['user'];?>" placeholder="Username Baru" disabled />
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="pass" id="pass" value="<?php echo $row['pass'];?>" placeholder="Password" disabled />
                  </div>
                </div>
				<div class="form-group">
                  ...
                  <div class="col-sm-10">
					<input type="text" class="form-control" name="level" id="level" value="<?php echo $row['level'];?>" placeholder="Level" disabled />
                  </div>
                </div>
				<div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="since" id="since" value="<?php echo $row['since'];?>" placeholder="since" disabled />
                  </div>
                </div>
				<div class="form-group">
              ...
              <div class="box-footer">
				<a type="button" class="btn btn-warning pull-right" href="user.php">Back</a>
              </div>
              <!-- /.box-footer -->
				<?php } ?>
			  </div>
